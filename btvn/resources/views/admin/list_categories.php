        ...
        <div class="box-body">
            ...
            <?php if(isset($_SESSION['error']['update'])): ;?>
                <div class="alert alert-danger alert-dismissible">
                    ...
                    <?php echo $_SESSION['error']['update']?>
                </div>
            <?php endif ;?>
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach ($data as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo BASE_PATH; ?>/admin/category/show/<?php echo $row['id']; ?>">
                                                <span class="label label-success"><?php echo $row['category_name']; ?></span></a>
                                        </td>
                                        <td><a href="<?php echo BASE_PATH;?>/admin/category/edit/<?php echo $row['id'];?>"><button class="btn btn-primary">Sửa</button></a></td>
                                        <td><a href="<?php echo BASE_PATH;?>/admin/category/delete/<?php echo $row['id'];?>"><button class="btn btn-danger">Xóa</button></a></td>
                                    </tr>
                                <?php endforeach; ?>
