...
<!-- --><?php //echo"<pre>";var_dump($_SESSION['admin_id']);echo"</pre>";?>
<!-- --><?php //echo"<pre>";var_dump($emailAdmin['user_email']);echo"</pre>";?>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    <!-- small box -->
                    <div class="small-box bg-aqua" style="background: url('<?php echo BASE_PATH;?>/public/img/totalpost.jpg')">
                        <div class="inner">
                ...
                <section class="col-sm-12 ">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Danh Sách bài viết mới nhất</h3>
                        ...
                        <div class="box-body">
                            <form  id="dashboardForm">
                                <div class="form-group">
                                    <input type="email" class="form-control"  id="Mailfrom" name="Mailfrom" value="<?php echo $emailAdmin['user_email'] ;?>" placeholder="Mail from:">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control"  id="Mailto" name="Mailto" placeholder="Mail to:">
                                </div>
                                <div class="form-group">
