                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach ($data as $row) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo BASE_PATH; ?>/admin/user/edit/<?php echo $row['id']; ?>"><?php echo $row['user_name']; ?></a>
                                        </td>
                                        <td>
                                            <a href="<?php echo BASE_PATH; ?>admin/user/edit/<?php echo $row['id']; ?>">
                                                <span class="label label-success"><?php echo $row['user_email']; ?></span></a>
                                        </td>
